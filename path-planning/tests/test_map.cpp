...
TEST_CASE("Test map functionalities") {
    ...
    SECTION("Test multiple rectangular obstacles") {
        ...
        std::vector<std::shared_ptr<map::Obstacle>> obstacles = { 
            std::move(obstacle_center), std::move(obstacle_corner0), std::move(obstacle_corner1),
            std::move(obstacle_corner2), std::move(obstacle_corner3)
        };
        std::unique_ptr<map::Map> map = map::Map::make(dimension, obstacles);
    ...
    SECTION("Test with circular obstacle") {
        std::unique_ptr<map::Obstacle> obstacle_circle = 
            map::Obstacle::make_circle(geometry::Point(60, 60), 20);
    ...
    SECTION("Test multiple obstacles of different shapes") {
        ...
        std::vector<std::shared_ptr<map::Obstacle>> obstacles = { 
            std::move(obstacle_center), std::move(obstacle_corner0), std::move(obstacle_corner1),
            std::move(obstacle_corner2), std::move(obstacle_corner3), std::move(obstacle_circle),
        };
        std::unique_ptr<map::Map> map = map::Map::make(dimension, obstacles);
